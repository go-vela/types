...
func TestDatabase_BuildExecutable_ToLibrary(t *testing.T) {
	// setup types
	want := new(library.BuildExecutable)
	...
	// run test
	got := testBuildExecutable().ToLibrary()
...
func TestDatabase_BuildExecutableFromLibrary(t *testing.T) {
	// setup types
	c := new(library.BuildExecutable)
	...
	// run test
	got := BuildExecutableFromLibrary(c)

	if !reflect.DeepEqual(got, want) {
		t.Errorf("BuildExecutableFromLibrary is %v, want %v", got, want)
	}
}
