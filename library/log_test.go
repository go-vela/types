...
func TestLibrary_Log_Getters(t *testing.T) {
	...
	for _, test := range tests {
		...
		if test.log.GetInitStepID() != test.want.GetInitStepID() {
			t.Errorf("GetInitStepID is %v, want %v", test.log.GetInitStepID(), test.want.GetInitStepID())
		}
...
func TestLibrary_Log_Setters(t *testing.T) {
	...
	for _, test := range tests {
		...
		test.log.SetInitStepID(test.want.GetInitStepID())
		...
		if test.log.GetInitStepID() != test.want.GetInitStepID() {
			t.Errorf("SetInitStepID is %v, want %v", test.log.GetInitStepID(), test.want.GetInitStepID())
		}
