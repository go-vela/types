...
func TestLibrary_Repo_Getters(t *testing.T) {
	...
	for _, test := range tests {
		...
		if test.repo.GetAllowPullFork() != test.want.GetAllowPullFork() {
			t.Errorf("GetAllowPullFork is %v, want %v", test.repo.GetAllowPullFork(), test.want.GetAllowPullFork())
		}
...
func TestLibrary_Repo_Setters(t *testing.T) {
	...
	for _, test := range tests {
		...
		test.repo.SetAllowPullFork(test.want.GetAllowPullFork())
		...
		if test.repo.GetAllowPullFork() != test.want.GetAllowPullFork() {
			t.Errorf("SetAllowPullFork is %v, want %v", test.repo.GetAllowPullFork(), test.want.GetAllowPullFork())
		}
