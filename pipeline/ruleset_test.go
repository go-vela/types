...
func TestPipeline_Ruleset_Match(t *testing.T) {
	...
	tests := []struct {
		...
		// If with and operator
		{
			...
			data:    &RuleData{Branch: "master", Event: "push", Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			want:    true,
		},
		{
			ruleset: &Ruleset{If: Rules{Branch: []string{"master"}}},
			data:    &RuleData{Branch: "dev", Event: "push", Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			want:    false,
		},
		{
		...
		{
			ruleset: &Ruleset{If: Rules{Branch: []string{"master"}, Event: []string{"push"}}},
			data:    &RuleData{Branch: "master", Event: "pull_request", Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			want:    false,
		},
		{
			ruleset: &Ruleset{If: Rules{Path: []string{"foo.txt", "/foo/bar.txt"}}},
			data:    &RuleData{Branch: "master", Event: "pull_request", Path: []string{}, Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			want:    false,
		},
		// If with or operator
		{
		...
		{
			ruleset: &Ruleset{If: Rules{Branch: []string{"master"}, Event: []string{"push"}}, Operator: "or"},
			data:    &RuleData{Branch: "dev", Event: "pull_request", Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			want:    false,
		},
		{
		...
		// Advanced Rulesets
		{
			...
			data: &RuleData{Branch: "master", Event: "tag", Repo: "octocat/hello-world", Status: "pending", Tag: "release/*"},
			want: true,
		},
		{
			ruleset: &Ruleset{
...
func TestPipeline_Rules_Match(t *testing.T) {
	...
	tests := []struct {
		...
		{
			rules:    &Rules{},
			data:     &RuleData{Branch: "master", Event: "push", Path: []string{"foo.txt", "/foo/bar.txt"}, Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			operator: "and",
			want:     true,
		},
		{
		...
		{
			rules:    &Rules{Branch: []string{"master"}},
			data:     &RuleData{Branch: "dev", Event: "push", Path: []string{"foo.txt", "/foo/bar.txt"}, Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			operator: "and",
			want:     false,
		},
		{
		...
		{
			rules:    &Rules{Branch: []string{"master"}, Event: []string{"push"}},
			data:     &RuleData{Branch: "dev", Event: "pull_request", Path: []string{"foo.txt", "/foo/bar.txt"}, Repo: "octocat/hello-world", Status: "pending", Tag: "refs/heads/master"},
			operator: "or",
			want:     false,
		},
		{
		...
		// Advanced Rulesets
		{
			...
			data:     &RuleData{Branch: "master", Event: "push", Repo: "octocat/hello-world", Status: "pending", Tag: "release/*"},
			operator: "or",
			want:     true,
		},
		{
